---
---This is age_of_statistics_in_days_all_databases_on_a_server_003.sql
---
---It will provide just a list of the databases on a server that need 
---to be reindexed/reorged
---
...
and 
databasename not in (''tempdb'', ''master'', ''model'', ''msdb'', ''ReportServer'', ''ReportServerTempDB'')
