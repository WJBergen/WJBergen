---
---This is Agent_Job_Schedule_Description.sql
---
/*
Agent Job Schedule Description
By Michael McCormick, 2016/05/06 

FROM:  http://www.sqlservercentral.com/scripts/SQL+Server/140544/

Of all the Agent Job Schedule Description scripts out there, this is another one. 
This sprang from a request for a report of all Agent Jobs and their schedules. 
I had a strong desire to make the descriptions grammatically correct, and found several scripts 
that were close, but not completely what I was looking for. 

I would like to acknowledge the contributions of two particular scripters upon which this script 
is founded upon. Ken Simmons, who revealed the existence of the sp_get_schedule_description 
procedure and exposed the code within, and Michelle Ufford, who had the idea of using the code 
as a CTE query for the overall job list query, and provided the basic structure of that query. 

For my part, I finished out the query with all schedule types available in SQL Server 2012, 
added some grammatical changes that I thought were important, and added another CTE with job 
history information. 
